...
const PAGES: Page[] = [
    ...
    { id: 'api_cosmetics', label: 'API Cosmetics', path: '/apis/repolib/api/cosmetics.html', category: 'api' },
    ...
    { id: 'sdk_cosmetics', label: 'SDK Cosmetics', path: '/apis/repolib/sdk/cosmetics.html', category: 'sdk' },
